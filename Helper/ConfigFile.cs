...
namespace Helper
{
    public class ConfigFile
    {
        ...
        public void Load(string path)
        {
            ...
            {
                Console.Error.WriteLine("Could not load config file: '{0}'{1}\t{2}", path, Environment.NewLine, ex.Message);
                return;
            }
            catch (Exception ex)
            {
                Console.Error.WriteLine("An unexpected error occurred while loading the config file: '{0}'{1}\t{2}",
        ...
        public void Save(string path)
        {
            ...
            sb.AppendLine("# Autogenerated config file");
            sb.Append("# ");
