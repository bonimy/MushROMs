...
namespace Helper
{
    public class Int16ByteIndexer : IIndexer<short>
    {
        ...
        {
            get => GetInt16Internal(Pointer, index);
            set => SetInt16Internal(Pointer, index, value);
        }
        ...
        private static short GetInt16Internal(Pointer<byte> pointer, int index) =>
            BitConverter.ToInt16(pointer.GetArray(), pointer.Offset + index);
