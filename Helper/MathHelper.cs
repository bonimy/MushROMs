...
{
    /// <summary>
    /// Provides constants and static methods for common mathematical functions not provided in
    /// the <see cref="Math"/> class.
    /// </summary>
    public static class MathHelper
    {
        ...
        public static float Max(float[] values)
        {
            ...
            if (values.Length == 0)
                throw new ArgumentException(SR.ErrorEmptyOrNullArray(nameof(values)),
                    nameof(values));
