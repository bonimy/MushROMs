...
namespace Helper.PixelFormats
{
    ...
    /// <c>[? r r r r r g g - g g g b b b b b]</c>. The most
    ...
    /// <see cref="UInt16"/>* data can be successfully cast to a pointer of type <see cref="Color15BppRgb555"/>*.
    /// </remarks>
    /// <threadsafety static="true" instance="false"/>
    [StructLayout(LayoutKind.Explicit)]
    public unsafe struct Color15BppRgb555
    {
        /// <summary>
        /// The size, in bytes, of <see cref="Color15BppRgb555"/>.
        /// This field is constant.
        /// </summary>
        public const int SizeOf = sizeof(short);

        /// <summary>
        /// Represents a <see cref="Color15BppRgb555"/> that has its <see cref="Value"/>
        /// set to 0.
        /// </summary>
        public static readonly Color15BppRgb555 Empty = new Color15BppRgb555();
        ...
        /// </summary>
        /// <remarks>
        /// This is the fundamental type of this <see cref="Color15BppRgb555"/>.
        /// </remarks>
        [FieldOffset(0)]
        ...
        /// this <see cref="Color15BppRgb555"/>. However, its value will be preserved through this
        /// object's lifetime.
        /// </remarks>
        public int Value
        {
        ...
        /// <summary>
        /// Gets or sets the red component of this <see cref="Color15BppRgb555"/> structure.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Gets or sets the green component of this <see cref="Color15BppRgb555"/> structure.
        /// </summary>
        /// <inheritdoc cref="Red"/>
        public int Green
        {
        ...
        /// <summary>
        /// Gets or sets the blue component of this <see cref="Color15BppRgb555"/> structure.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Color15BppRgb555"/> structure using the
        /// given color value.
        /// </summary>
        /// <param name="value">
        /// The color value.
        ...
        /// <overloads>
        /// <summary>
        /// Initializes a new instance of the <see cref="Color15BppRgb555"/> struct.
        /// </summary>
        /// </overloads>
        private Color15BppRgb555(ushort value) : this()
        {
            Value = value;
        }
        /// <summary>
        ...
        /// </param>
        public Color15BppRgb555(int red, int green, int blue)
            : this(
                (ushort)(
        ...
        /// <summary>
        /// Converts an <see cref="Int32"/> data type to a <see cref="Color15BppRgb555"/>
        /// structure.
        /// </summary>
        /// <param name="value">
        ...
        /// </param>
        /// <returns>
        /// The <see cref="Color15BppRgb555"/> that results from the conversion.
        /// </returns>
        public static implicit operator Color15BppRgb555(int value)
        {
            return new Color15BppRgb555((ushort)value);
        }
        /// <summary>
        /// Converts a <see cref="Color15BppRgb555"/> structure to an <see cref="Int32"/>
        /// data type.
        /// </summary>
        /// <param name="color15">
        /// The <see cref="Color15BppRgb555"/> to be converted.
        /// </param>
        /// <returns>
        /// The <see cref="Int32"/> that results from the conversion.
        /// </returns>
        public static implicit operator int(Color15BppRgb555 color15)
        {
            return color15.Value;
        }

        /// <summary>
        /// Converts a <see cref="Color24BppRgb"/> structure to a <see cref="Color15BppRgb555"/>
        /// structure.
        /// </summary>
        /// <param name="color24">
        ...
        /// The <see cref="Color15BppRgb555"/> that results from the conversion.
        /// </returns>
        public static explicit operator Color15BppRgb555(Color24BppRgb color24)
        {
            // Each component goes from 8 bits of sensitivity to 5
            // So we shift right 3 bytes for the conversion.
            return new Color15BppRgb555(
        ...
        /// <summary>
        /// Converts a <see cref="Color15BppRgb555"/> structure to a <see cref="Color24BppRgb"/>
        /// structure.
        /// </summary>
        /// <param name="color15">
        /// The <see cref="Color15BppRgb555"/> to be converted.
        ...
        /// </returns>
        public static implicit operator Color24BppRgb(Color15BppRgb555 color15)
        {
        ...
        /// <summary>
        /// Converts a <see cref="Color32BppArgb"/> structure to a <see cref="Color15BppRgb555"/>
        /// structure.
        /// </summary>
        /// <param name="color32">
        ...
        /// The <see cref="Color15BppRgb555"/> that results from the conversion.
        /// </returns>
        public static explicit operator Color15BppRgb555(Color32BppArgb color32)
        {
        ...
        /// <summary>
        /// Converts a <see cref="Color15BppRgb555"/> structure to a <see cref="Color32BppArgb"/>
        /// structure.
        /// </summary>
        /// <param name="color15">
        /// The <see cref="Color15BppRgb555"/> to be converted.
        ...
        /// </returns>
        public static implicit operator Color32BppArgb(Color15BppRgb555 color15)
        {
            // Same as the 24-bit color conversion; we ignore the alpha component.
        ...
        /// <summary>
        /// Compares two <see cref="Color15BppRgb555"/> objects. The result specifies whether
        /// the <see cref="Red"/>, <see cref="Green"/>, and
        /// <see cref="Blue"/> components are equal.
        /// </summary>
        /// <param name="left">
        /// A <see cref="Color15BppRgb555"/> to compare.
        /// </param>
        /// <param name="right">
        /// A <see cref="Color15BppRgb555"/> to compare.
        /// </param>
        ...
        /// </returns>
        public static bool operator ==(Color15BppRgb555 left, Color15BppRgb555 right)
        {
        ...
        public static explicit operator Color15BppRgb555(ColorF color)
        {
            return new Color15BppRgb555(
        ...
        public static implicit operator ColorF(Color15BppRgb555 pixel)
        {
        ...
        /// <summary>
        /// Specifies whether this <see cref="Color15BppRgb555"/> is the same color as
        ...
        /// <see cref="Color15BppRgb555"/>; otherwise <see langword="false"/>.
        /// </returns>
        public override bool Equals(object obj)
        {
            if (!(obj is Color15BppRgb555))
                return false;

            return (Color15BppRgb555)obj == this;
        }
        /// <summary>
        /// Returns a hash code for this <see cref="Color15BppRgb555"/>.
        /// </summary>
        /// <returns>
        ...
        /// </summary>
        /// <returns>
        /// A <see cref="String"/> the represent this <see cref="Color15BppRgb555"/>.
        /// </returns>
